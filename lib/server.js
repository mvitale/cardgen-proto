 ...
 * of the JSON request
 */
app.post('/deckPdfs', nocache(), cardRoutes.createDeckPdf);
app.get('/deckPdfs/:id/status', nocache(), cardRoutes.deckPdfStatus);
app.get('/deckPdfs/:id/result', cardRoutes.deckPdfResult);

/*
 * GET public decks
 */
app.get('/public/decks', nocache(), cardRoutes.getPublicDecks);

/*
 * GET public cards
 */
app.get('/public/cards', nocache(), cardRoutes.getPublicCards);

/*
 * GET the status of a job started with cardRoutes.populateDeckFromCollection
 */
app.get('/collectionJob/:jobId/status', nocache(), cardRoutes.collectionJobStatus);
