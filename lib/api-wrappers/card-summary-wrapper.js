...
function CardSummaryWrapper(delegate, wrapped) {
  ...
  this.toJSON = function() {
    ...
    // have one template.
    /*
    json.commonName = this.wrapped.getDataAttr('commonName', 'text', '');
    json.sciName = this.wrapped.getDataAttr('sciName', 'text', '');
    */
    json.commonName = '';
    json.sciName = '';
...
function newInstance(delegate) {
  return new Promise((resolve, reject) => {
    ...
    */
    resolve(new CardSummaryWrapper(delegate, null));
  });
}
