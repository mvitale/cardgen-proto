...
module.exports.deckPdf = deckPdf;

function getDeckPdf(req, res) {
  res.setHeader('Content-Type', 'application/pdf');
  deckPdfMaker.pipePdf(req.params.id, res);
}
module.exports.getDeckPdf = getDeckPdf;
