...
function getPublicCardsByTaxonId(req, res, next) {
  var taxonId;

  try {
    taxonId = parseInt(req.params.taxonId);
  } catch (e) {
    return next(e);
  }

  return resourceHelpers.publicCards(req.appId, { 
    'templateParams.speciesId': taxonId
  })
  .then((cards) => {
    cardSummaryHelper(req, res, cards); 
  })
...
module.exports.getPublicCardsByTaxonId = getPublicCardsByTaxonId;
